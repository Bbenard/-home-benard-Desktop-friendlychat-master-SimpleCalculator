...
//        });
    ...
    private class ButtonClickHandler implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            ...
            TextView textViewOutputScreen = (TextView)findViewById(R.id.outputscreen);
            ...
            if(v instanceof Button){
                ...
                // Check for the equals sign. If pressed, then calculate our result
                    ...
                    try {
                        double calcResult = Cal.evaluate(textViewOutputScreen.getText().toString());
                ...
                // Check if two math operators pressed in a row. If so, show an error message using Toast
                        ...
                        Cal.isoperator(textViewOutputScreen.getText().charAt(textViewOutputScreen.getText().length() - 1)) &&
                        Cal.isoperator(buttonClicked.getText().charAt(0)))
                {
